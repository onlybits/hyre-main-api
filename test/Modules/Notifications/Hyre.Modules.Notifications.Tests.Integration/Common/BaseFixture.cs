...
public abstract class BaseFixture : IClassFixture<IntegrationTestsWebApplicationFactory>
{
	...
	/// <summary>
	///   Creates a new instance of the <see cref="NotificationsRepositoryContext" />.
	/// </summary>
	/// <returns>It will return a new instance of the <see cref="NotificationsRepositoryContext" />.</returns>
	internal NotificationsRepositoryContext CreateRepositoryContext()
	{
		var serviceScope = _factory.Services.CreateScope();
		var repositoryContext = serviceScope.ServiceProvider.GetRequiredService<NotificationsRepositoryContext>();
