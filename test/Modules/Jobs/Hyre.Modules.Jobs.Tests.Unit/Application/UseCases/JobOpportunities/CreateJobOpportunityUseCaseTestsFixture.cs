...
/// </summary>
public abstract class CreateJobOpportunityUseCaseTestsFixture : BaseFixture
{
	/// <summary>
	...
	private CreateJobOpportunityInput GenerateValidInput() => new(Faker.Name.JobTitle().ClampLength(3, 32));
}