...
/// </summary>
public sealed class FindJobOpportunityUseCaseTests : JobOpportunityBaseFixture
{
	...
	{
		// Arrange
		var request = GenerateFindJobOpportunityRequest();
		var finalResult = GenerateJobOpportunity();
		_ = _repository
			.JobOpportunity
