...
migration_name=$1
project_path="../src/Modules/Identity/Hyre.Modules.Identity.Infrastructure/Hyre.Modules.Identity.Infrastructure.csproj"
startup_project="../src/Bootstrapper/Hyre.Bootstrapper/Hyre.Bootstrapper.csproj"
context="Hyre.Modules.Identity.Infrastructure.IdentityRepositoryContext"
configuration="Debug"
