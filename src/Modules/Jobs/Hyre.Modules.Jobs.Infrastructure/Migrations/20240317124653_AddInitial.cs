	...
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		...
		migrationBuilder.CreateTable(
			...
			columns: table => new
			{
				...
				disability_hearing = table.Column<bool>(type: "boolean", nullable: true),
				disability_vision = table.Column<bool>(type: "boolean", nullable: true),
				disability_intellectual = table.Column<bool>(type: "boolean", nullable: true),
				disability_physical = table.Column<bool>(type: "boolean", nullable: true),
				...
				social_network_linkedin = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
				social_network_github = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
		...
		migrationBuilder.CreateTable(
			name: "candidate_job_opportunity",
			schema: "jobs",
			columns: table => new
			{
				candidates_id = table.Column<Guid>(type: "uuid", nullable: false),
				job_opportunities_id = table.Column<Guid>(type: "uuid", nullable: false)
			},
			constraints: table =>
			{
				table.PrimaryKey("pk_candidate_job_opportunity", x => new { x.candidates_id, x.job_opportunities_id });
				table.ForeignKey(
					name: "fk_candidate_job_opportunity_candidates_candidates_id",
				...
				table.ForeignKey(
					name: "fk_candidate_job_opportunity_job_opportunities_job_opportuniti",
					column: x => x.job_opportunities_id,
					principalSchema: "jobs",
		...
		migrationBuilder.CreateIndex(
			name: "ix_candidate_job_opportunity_job_opportunities_id",
			schema: "jobs",
