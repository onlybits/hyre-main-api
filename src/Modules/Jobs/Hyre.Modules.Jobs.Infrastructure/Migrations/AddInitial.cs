	...
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		...
		migrationBuilder.CreateTable(
			...
			columns: table => new
			{
				...
				phone_area_code = table.Column<string>("text", nullable: false),
				phone_number = table.Column<string>("text", nullable: false),
				address_country = table.Column<string>("text", nullable: false),
				address_state = table.Column<string>("text", nullable: false),
				address_city = table.Column<string>("text", nullable: false),
				address_neighborhood = table.Column<string>("text", nullable: false),
				address_complement = table.Column<string>("text", nullable: true),
				...
				social_network_linkedin = table.Column<string>("text", nullable: true),
				social_network_github = table.Column<string>("text", nullable: true),
