...
/// <summary>
///   Exception that is thrown when the refresh token is invalid.
/// </summary>
public sealed class RefreshTokenInvalidException : BadRequestException
{
	/// <summary>
	///   Initializes a new instance of the <see cref="UserInvalidCredentialsException" /> class.
	/// </summary>
	public RefreshTokenInvalidException() : base(UserErrorMessages.InvalidRefreshToken)
	{
	}
}